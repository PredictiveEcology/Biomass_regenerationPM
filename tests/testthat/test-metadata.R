...
test_that("inputs are the expected names and classes", {
  ...
  expect_identical(
    ...
    c(cohortData                       = "data.table",
      fireCFBRas                       = "RasterLayer",
      fireDamageTable                  = "data.table",
      fireROSRas                       = "RasterLayer",
      fireRSORas                       = "RasterLayer",
      inactivePixelIndex               = "logical",
      pixelGroupMap                    = "RasterLayer",
      rstCurrentBurn                   = "RasterLayer",
      species                          = "data.table",
...
test_that("parameters are the expected names", {
  ...
  expect_identical(
    ...
    sort(c(".plotInitialTime", ".plotInterval", ".plots", ".saveInitialTime",
           ".saveInterval", ".useCache", "calibrate", "fireInitialTime", "fireTimestep",
           "initialB", "LANDISPM", "successionTimestep"))
  )
})
